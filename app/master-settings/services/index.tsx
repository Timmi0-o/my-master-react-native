import { MasterServicesListPage } from '@/components/pages/master-settings/services/list/master-services-list-page'
...
export default function MasterServicesScreen(): ReactElement {
	...
	return <MasterServicesListPage masterProfile={masterProfile} />
}
